...
2 Then, swap the first and last characters of the string
3 Then, swap the second and second last characters of the string
4 Continue this process until the middle of the string is reached
*/
...
/*
*1 Declare a function that returns an integer and takes a pointer as argument
