...
/*
*1 Function that takes a string as an argument
2 Integer variable to hold the length of the string
3 Integer variable to hold the index of the string
